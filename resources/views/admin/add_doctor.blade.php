        ...
        <div class = "container" align = "center" style = "padding-top: 100px;">
              ...
              @if(session()->has('message'))
                <script>
                  ...
                  if (confirm(message)) {
                    // User clicked OK (or accepted)
                    // You can add any further actions here if needed
                  } else {
                    // User clicked Cancel (or declined)
                    // You can add any actions for this case as well
                  }
                </script>
              @endif
            ...
            <form action = "{{url('upload_doctor')}}" method = "POST" enctype = "multipart/form-data">
                ...
                <div style = "padding : 15px;">
                    <label>Phone</label>
                    <input type = "number" name="number" placeholder="write the number" required = "" style = "color:black;">
                </div>
